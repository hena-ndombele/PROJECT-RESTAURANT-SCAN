...
$ti-font-family: 'tabler-icons-300' !default;
...
@font-face {
  ...
  src: url('#{$ti-font-path}/tabler-icons-300.woff2?v3.41.0') format('woff2'),
    url('#{$ti-font-path}/tabler-icons-300.woff?') format('woff'),
    url('#{$ti-font-path}/tabler-icons-300.ttf?v3.41.0') format('truetype');
}
...
.#{$ti-prefix}-seeding:before { content: $ti-icon-seedling; }
.#{$ti-prefix}-seeding-off:before { content: $ti-icon-seedling-off; }
.#{$ti-prefix}-brand-adobe-premier:before { content: $ti-icon-brand-adobe-premiere; }

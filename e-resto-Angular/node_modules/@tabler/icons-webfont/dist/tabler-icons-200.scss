...
$ti-font-family: 'tabler-icons-200' !default;
...
@font-face {
  ...
  src: url('#{$ti-font-path}/tabler-icons-200.woff2?v3.41.0') format('woff2'),
    url('#{$ti-font-path}/tabler-icons-200.woff?') format('woff'),
    url('#{$ti-font-path}/tabler-icons-200.ttf?v3.41.0') format('truetype');
}

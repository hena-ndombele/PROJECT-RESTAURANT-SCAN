...
export class PricingPage {
  plans: PricingPlan[] = [
    ...
    },
    {
      ...
      max_tables: null,
      max_users: null,
      features: ['Tables illimitées', 'Commandes illimitées', 'Plats illimités', 'Réservations', 'Feedback client', 'Statistiques detaillées', 'Couleurs personnalisées', 'Support prioritaire'],
      installation_fee: 20_000,

...
<head>
    <meta charset="UTF-8">
    <title>Mot de passe modifie - <?php echo e($restaurantName); ?></title>
</head>
                ...
                <table role="presentation" width="100%" cellspacing="0" cellpadding="0" style="max-width:600px;background:#ffffff;border:1px solid #e5e7eb;border-radius:16px;overflow:hidden;box-shadow:0 18px 45px rgba(17,24,39,.08);">
                    ...
                    <tr>
                        <td style="padding:30px;">
                            <p style="margin:0 0 14px;color:#374151;line-height:1.7;">Bonjour <?php echo e(trim(($user->first_name ?? '') . ' ' . ($user->last_name ?? '')) ?: 'Serveur'); ?>,</p>
                            <p style="margin:0;color:#374151;line-height:1.7;">Votre mot de passe vient d'etre modifie avec succes sur <?php echo e($restaurantName); ?>.</p>
...
<?php /**PATH C:\xampp\htdocs\PROJECT-RESTAURANT-SCAN\e-resto-backend\resources\views/emails/password_changed.blade.php ENDPATH**/ ?>
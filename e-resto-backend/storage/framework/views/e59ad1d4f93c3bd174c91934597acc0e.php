...
<body>
    <div class="container">
        ...
        <div class="content">
            <p>Bonjour <?php echo e($user->first_name); ?> <?php echo e($user->last_name); ?>,</p>
            ...
            <div class="panel">
                ...
                <strong>Plan :</strong> <?php echo e($restaurant->plan?->name ?? 'Plan E-RESTO'); ?><br>
                <strong>Statut :</strong> <?php echo e($restaurant->status); ?>

            </div>

            <?php if($restaurant->status === 'trial'): ?>
                <p>Votre essai gratuit est actif jusqu'au <?php echo e(optional($restaurant->trial_ends_at)->format('d/m/Y')); ?>.</p>
            ...
            <p>
                <a class="button" href="<?php echo e(config('app.url')); ?>">Ouvrir E-RESTO</a>
            </p>
        </div>
        <div class="footer">
            &copy; <?php echo e(date('Y')); ?> E-RESTO. Cet email confirme la creation de votre compte.
        </div>
    </div>
</body>
</html>

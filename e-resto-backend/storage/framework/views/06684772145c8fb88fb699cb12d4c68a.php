        ...
        <tr>
            <td align="center">
                <table role="presentation" width="100%" cellspacing="0" cellpadding="0" style="max-width:620px;background:#ffffff;border:1px solid #e5e7eb;border-radius:16px;overflow:hidden;box-shadow:0 18px 45px rgba(17,24,39,.08);">
                    <tr>
                        <td style="padding:30px;background:<?php echo e($primaryColor); ?>;color:#ffffff;">
                            <img src="<?php echo e($message->embed($logoPath)); ?>" alt="<?php echo e($restaurant?->name ?? 'Restaurant Scan'); ?>" width="112" height="72" style="display:block;border-radius:12px;margin-bottom:16px;object-fit:contain;background:#ffffff;">
                            ...
                            <p style="margin:12px 0 0;color:#f9fafb;line-height:1.6;">Bonjour <?php echo e($user->first_name); ?> <?php echo e($user->last_name); ?>, <?php echo e($restaurant?->name ?? 'Restaurant Scan'); ?> vient de vous donner un acces.</p>
                        </td>
                    </tr>
                    <tr>
                        <td style="padding:28px;">
                            <table role="presentation" width="100%" cellspacing="0" cellpadding="0" style="border:1px solid <?php echo e($primaryColor); ?>;background:#fff7ed;border-radius:12px;margin-bottom:22px;">
                                <tr>
...
<?php /**PATH C:\xampp\htdocs\PROJECT-RESTAURANT-SCAN\e-resto-backend\resources\views/emails/account_created.blade.php ENDPATH**/ ?>
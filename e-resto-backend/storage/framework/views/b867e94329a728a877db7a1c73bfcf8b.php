                    ...
                    <tr>
                        <td style="padding:30px;text-align:center;">
                            ...
                            <p style="margin:24px 0 0;">
                                <a href="<?php echo e(config('app.frontend_url', config('app.url'))); ?>" style="display:inline-block;padding:13px 18px;border-radius:10px;background:linear-gradient(135deg,#ff7a1a,#d71920);color:#ffffff;text-decoration:none;font-weight:700;">Ouvrir Restaurant Scan</a>
                            </p>
                        </td>
                    </tr>
                    <tr>
                        <td style="padding:18px 28px;background:#f9fafb;color:#6b7280;font-size:13px;line-height:1.6;text-align:center;">
                            &copy; <?php echo e(date('Y')); ?> Restaurant Scan. Besoin d'aide ? <a href="mailto:restaurantScan2026@gmail.com" style="color:#d71920;text-decoration:none;">restaurantScan2026@gmail.com</a>
                        </td>
                    </tr>
                </table>
            </td>

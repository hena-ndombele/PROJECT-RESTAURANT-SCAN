                ...
                <table role="presentation" width="100%" cellspacing="0" cellpadding="0" style="max-width:640px;background:#ffffff;border:1px solid #e5e7eb;border-radius:16px;overflow:hidden;box-shadow:0 18px 45px rgba(17,24,39,.08);">
                    <tr>
                        <td style="padding:32px;background:linear-gradient(135deg,#ff7a1a,#d71920);color:#ffffff;">
                            <img src="<?php echo e($message->embed(public_path('assets/logo.png'))); ?>" alt="Restaurant Scan" width="118" height="76" style="display:block;border-radius:12px;margin-bottom:16px;object-fit:contain;background:#ffffff;">
                            ...
                            <p style="margin:12px 0 0;color:#e5e7eb;line-height:1.6;">Bonjour <?php echo e($user->first_name); ?> <?php echo e($user->last_name); ?>, votre compte a été créé avec succès.</p>
                        </td>
                    </tr>
                    <tr>
                        <td style="padding:28px;">
                            <table role="presentation" width="100%" cellspacing="0" cellpadding="0" style="border:1px solid #fed7aa;background:#fff7ed;border-radius:12px;margin-bottom:22px;">
                                <tr>
                                    <td style="padding:18px;color:#111827;line-height:1.8;">
                                        ...
                                        <strong>Plan :</strong> <?php echo e($restaurant->plan?->name ?? 'Plan Restaurant Scan'); ?><br>
                            ...
                            <?php if($restaurant->status === 'trial'): ?>
                                <p style="margin:0 0 18px;color:#374151;line-height:1.7;">Votre essai gratuit est actif jusqu'au <strong><?php echo e(optional($restaurant->trial_ends_at)->format('d/m/Y')); ?></strong>. Vous pouvez déjà configurer le menu, les tables QR et votre équipe.</p>
                            ...
                            <a href="<?php echo e(config('app.frontend_url', config('app.url'))); ?>" style="display:inline-block;padding:14px 20px;border-radius:10px;background:linear-gradient(135deg,#ff7a1a,#d71920);color:#ffffff;text-decoration:none;font-weight:700;">Ouvrir Restaurant Scan</a>
                        </td>
                    </tr>
                    <tr>
                        <td style="padding:18px 28px;background:#f9fafb;color:#6b7280;font-size:13px;line-height:1.6;">
                            &copy; <?php echo e(date('Y')); ?> Restaurant Scan. Menu QR, commandes, paiements et rapports pour restaurants.
                        </td>
                    </tr>
                </table>
            </td>
...
<?php /**PATH C:\xampp\htdocs\PROJECT-RESTAURANT-SCAN\e-resto-backend\resources\views/emails/restaurant_account_created.blade.php ENDPATH**/ ?>
...
<head>
    <meta charset="UTF-8">
    <title>Code de verification {{ $restaurantName }}</title>
</head>
                ...
                <table role="presentation" width="100%" cellspacing="0" cellpadding="0" style="max-width:600px;background:#ffffff;border:1px solid #e5e7eb;border-radius:16px;overflow:hidden;box-shadow:0 18px 45px rgba(17,24,39,.08);">
                    ...
                    <tr>
                        <td style="padding:30px;text-align:center;">
                            <p style="margin:0;color:#374151;line-height:1.7;">Utilisez ce code pour confirmer votre connexion a {{ $restaurantName }}.</p>
                            <div style="display:inline-block;margin:24px 0;padding:18px 26px;border:1px solid #fed7aa;border-radius:14px;background:#fff7ed;color:{{ $secondaryColor }};font-size:38px;letter-spacing:8px;font-weight:800;">{{ $otp }}</div>
                            ...
                            <p style="margin:24px 0 0;">
                                <a href="{{ config('app.frontend_url', config('app.url')) }}" style="display:inline-block;padding:13px 18px;border-radius:10px;background:{{ $primaryColor }};color:#ffffff;text-decoration:none;font-weight:700;">Ouvrir Restaurant Scan</a>
                            </p>
                        </td>
                    </tr>
                    <tr>
                        <td style="padding:18px 28px;background:#f9fafb;color:#6b7280;font-size:13px;line-height:1.6;text-align:center;">
                            &copy; {{ date('Y') }} {{ $restaurantName }}. Besoin d'aide ? <a href="mailto:restaurantScan2026@gmail.com" style="color:{{ $secondaryColor }};text-decoration:none;">restaurantScan2026@gmail.com</a>
                        </td>
                    </tr>
                </table>
            </td>

                ...
                <table role="presentation" width="100%" cellspacing="0" cellpadding="0" style="max-width:600px;background:#ffffff;border:1px solid #e5e7eb;border-radius:16px;overflow:hidden;box-shadow:0 18px 45px rgba(17,24,39,.08);">
                    <tr>
                        <td style="padding:30px;background:linear-gradient(135deg,#ff7a1a,#d71920);color:#ffffff;text-align:center;">
                            <img src="{{ $message->embed(public_path('assets/logo.png')) }}" alt="Restaurant Scan" width="112" height="72" style="display:inline-block;border-radius:12px;margin-bottom:14px;object-fit:contain;background:#ffffff;">
                    ...
                    <tr>
                        <td style="padding:30px;text-align:center;">
                            <p style="margin:0;color:#374151;line-height:1.7;">Utilisez ce code pour confirmer votre connexion a Restaurant Scan.</p>
                            ...
                            <p style="margin:24px 0 0;">
                                <a href="{{ config('app.frontend_url', config('app.url')) }}" style="display:inline-block;padding:13px 18px;border-radius:10px;background:linear-gradient(135deg,#ff7a1a,#d71920);color:#ffffff;text-decoration:none;font-weight:700;">Ouvrir Restaurant Scan</a>
                            </p>
                        </td>
                    </tr>
                    <tr>
                        <td style="padding:18px 28px;background:#f9fafb;color:#6b7280;font-size:13px;line-height:1.6;text-align:center;">
                            &copy; {{ date('Y') }} Restaurant Scan. Besoin d'aide ? <a href="mailto:restaurantScan2026@gmail.com" style="color:#d71920;text-decoration:none;">restaurantScan2026@gmail.com</a>
                        </td>
                    </tr>
                </table>
            </td>

                ...
                <table role="presentation" width="100%" cellspacing="0" cellpadding="0" style="max-width:640px;background:#ffffff;border:1px solid #e5e7eb;border-radius:16px;overflow:hidden;box-shadow:0 18px 45px rgba(17,24,39,.08);">
                    <tr>
                        <td style="padding:30px;background:#111827;color:#ffffff;">
                            <div style="font-size:12px;letter-spacing:.16em;text-transform:uppercase;color:#ffb15c;font-weight:700;">E-RESTO Support</div>
                    ...
                    <tr>
                        <td style="padding:28px;">
                            ...
                            <div style="padding:18px;border:1px solid #e5e7eb;border-radius:12px;background:#f9fafb;color:#1f2937;line-height:1.7;white-space:pre-line;">{{ $contactMessage->message }}</div>

                            <p style="margin:24px 0 0;">
                                <a href="mailto:{{ $contactMessage->email }}" style="display:inline-block;padding:13px 18px;border-radius:10px;background:#d71920;color:#ffffff;text-decoration:none;font-weight:700;">Repondre au client</a>
                            </p>
                        </td>
                    </tr>
                    <tr>
                        <td style="padding:18px 28px;background:#f9fafb;color:#6b7280;font-size:13px;line-height:1.6;">
                            &copy; {{ date('Y') }} E-RESTO. Message conserve dans le tableau de support plateforme.
                        </td>
                    </tr>
                </table>
            </td>

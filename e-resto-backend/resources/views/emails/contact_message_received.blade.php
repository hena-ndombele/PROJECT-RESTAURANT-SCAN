                    ...
                    <tr>
                        <td style="padding:28px;">
                            ...
                            <p style="margin:24px 0 0;">
                                <a href="mailto:{{ $contactMessage->email }}" style="display:inline-block;padding:13px 18px;border-radius:10px;background:linear-gradient(135deg,#ff7a1a,#d71920);color:#ffffff;text-decoration:none;font-weight:700;">Repondre au client</a>
                            </p>
                        </td>
                    </tr>
                    <tr>
